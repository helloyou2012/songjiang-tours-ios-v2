...
@implementation JiaotongRequest
...
- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)response
{
    ...
    if (statusCode > 400)
    {
        ...
        [_delegate jiaotongRequestFinished:nil withError:@"网络连接失败！"];
    }
}
...
{
    [_delegate jiaotongRequestFinished:nil withError:@"加载失败！"];
}
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    if(json!=nil) {
        [_delegate jiaotongRequestFinished:json withError:nil];
    }else{
        [_delegate jiaotongRequestFinished:nil withError:@"没有数据！"];
    }
}
@end
